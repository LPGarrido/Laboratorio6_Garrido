# 1 "main_laboratorio6.s"
# 1 "<built-in>" 1
# 1 "main_laboratorio6.s" 2
...
CONFIG_TMR2:
 ...
 CONFIG_IO:
    ...
    MOVLW 0xFC
    MOVWF TRISD ;((PORTD) and 07Fh), 0 y ((PORTD) and 07Fh), 1 como salida
    MOVLW 0xFE
    MOVWF TRISA ;((PORTA) and 07Fh), 0 como salida
    BANKSEL PORTD
...
CONFIG_INT:
    ...
    BSF ((PIE1) and 07Fh), 1 ; Habilitamos int. TMR1
...
MOSTRAR_VALORES:
    BCF PORTD,0 ;Limpiar ((PORTD) and 07Fh), 0
    BCF PORTD,1 ;Limpiar ((PORTD) and 07Fh), 1
